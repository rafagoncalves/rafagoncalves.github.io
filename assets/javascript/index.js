...
// Add class to header when scroll the page
$(window).scroll(function () {
  var top = $(window).scrollTop();
  if( top > 100 ){
    $(".js-header").addClass("main-header--fixed");
  } else {
    $(".js-header").removeClass("main-header--fixed");
  }
});
...
$('.js-menu-mobile').click(function(e){
  ...
  $(".js-menu").toggleClass("nav--is-open");
});

$(function(){
  $('.js-field').data('holder',$('.js-field').attr('placeholder'));
  $('.js-field').focusin(function(){
      $(this).attr('placeholder','');
  });
  $('.js-field').focusout(function(){
